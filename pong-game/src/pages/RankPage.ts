export function render() {
	document.body.innerHTML = `
	  <div class="min-h-screen bg-gray-100 flex flex-col items-center justify-center text-center px-4 font-press">
		<h1 class="text-3xl text-gray-800 mb-6">🏆 Tournament Rank</h1>
		<div class="bg-white shadow-lg rounded-xl w-full max-w-2xl p-6 space-y-4">
		  <div class="flex justify-between items-center border-b pb-2">
			<div class="flex items-center gap-3">
			  ...
			  <span class="text-gray-800">PlayerOne</span>
			</div>
		  ...
		  <div class="flex justify-between items-center border-b pb-2">
			<div class="flex items-center gap-3">
			  ...
			  <span class="text-gray-800">PlayerTwo</span>
			</div>
