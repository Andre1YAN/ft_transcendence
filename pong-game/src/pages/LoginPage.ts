	...
	document.body.innerHTML = `
	  <div class="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center px-4">
		<div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
		  <h2 class="text-3xl font-bold text-center mb-6 text-gray-800 font-press">Welcome Back</h2>
		  ...
		  <div class="relative mb-5 text-center text-gray-500 text-sm">
			<span class="bg-white px-2">or login with email</span>
		  ...
		  <form class="space-y-4">
			<input
			  ...
			  class="w-full bg-white text-black border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
			/>
			<input
			  type="password"
			...
			<button
			  type="submit"
			  class="w-full bg-black text-white font-semibold py-2 rounded-md hover:opacity-90 transition"
			>
			  Login
			</button>
		  </form>
		  ...
		  <p class="text-sm text-center text-gray-500 mt-6">
			...
			<a href="#/signup" class="text-orange-500 hover:underline">Register</a>
		  </p>
		</div>
	  </div>
	`
